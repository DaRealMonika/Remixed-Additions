...
return mob.init({
    ...
    spawn = function(self, mob, level)
        RPD.Actor:remove(RPD.new(RPD.Objects.Actors.ScriptedActor,"scripts/actors/Bosses/CeaselessVoid/Terror"))
        level:addScriptedActor(RPD.new(RPD.Objects.Actors.ScriptedActor,"scripts/actors/Bosses/CeaselessVoid/Terror"))
    end]]
})